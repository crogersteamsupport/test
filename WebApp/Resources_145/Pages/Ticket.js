...
$(document).ready(function () {
  ...
  function initEditor(element, init) {
    var editorOptions = {
      ...
      theme_advanced_buttons1: "insertTicket,insertKb,|,link,unlink,|,undo,redo,removeformat,|,cut,copy,paste,pastetext,pasteword,|,cleanup,code,|,blockquote,|,outdent,indent,|,bullist,numlist,|,spellchecker",
      theme_advanced_buttons2: "forecolor,backcolor,fontselect,fontsizeselect,bold,italic,underline,strikethrough,|,tablecontrols",
      ...
      convert_urls: true,
      relative_urls: false,
      content_css: "../Css/jquery-ui-latest.custom.css,../Css/ts.ui.css",
  ...
  if (top.Ts.System.Organization.ProductType === 0 || top.Ts.System.Organization.ProductType === 1) {
  ...
  function loadTicket(ticketNumber) {
    top.Ts.Services.Tickets.GetTicketInfo(ticketNumber, function (info) {
      ...
      var ticketUrl = window.location.href.replace('Resources_144/Pages/Ticket.html', '');
      $('<a>')
      .attr('href', ticketUrl)
      .attr('target', '_blank')
      .text(ticketUrl)
