        ...
        case Ts.Ui.Tabs.Tab.Type.Ticket:
          ...
          if (div.length < 1) {
            ...
            $('<iframe>')
              ...
              .attr('scrolling', 'no')
              .appendTo(div)
              .attr('src', 'Resources_150/Pages/Ticket.html?TicketNumber=' + tab.getId());
          }
          else {
            div.show();
          }
          $('.main-info-content').load('Resources_150/PaneInfo/ticket.html');
        ...
        case Ts.Ui.Tabs.Tab.Type.NewTicket:
          ...
          if (div.length < 1) {
            ...
            $('<iframe>')
              ...
              .attr('scrolling', 'no')
              .appendTo(div)
              .attr('src', 'Resources_150/Pages/NewTicket.html' + query);
            //.attr('src', 'frames/newticket.aspx' + query);
          }
          else {
            div.show();
          }
          $('.main-info-content').load('Resources_150/PaneInfo/newticket.html');
          break;
        default:
  ...
  editReminder: function (reminder, doSave, callback) {
    ...
    buttons.OK = function () {
      ...
      top.Ts.Services.System.EditReminder(
        ...
        reminder.RefType,
        reminder.RefID,
        $('.dialog-reminder .reminder-description').val(),
        top.Ts.Utils.getMsDate($('.dialog-reminder .reminder-date').datetimepicker('getDate')),
        $('.dialog-reminder .reminder-user').val(),
        callback
      );
    }
