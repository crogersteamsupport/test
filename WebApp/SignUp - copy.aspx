<%@ Page Language="C#" MasterPageFile="~/StandardForm.master" AutoEventWireup="true"
  CodeFile="SignUp - copy.aspx.cs" Inherits="SignUp" Title="TeamSupport - Sign Up" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
  ...
  <script type="text/javascript" language="javascript">
    ...
    function validate() {
      PageMethods.IsCompanyValid('kevin', func)
      alert('validate');
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div style="font-size: 24px; padding: 0 0 10px 10px;">Setup your 14 day free trial</div>
      ...
      <div style="padding-top: 20px; text-align: left;">
        ...
        <br />
        <br />
        <asp:Button ID="btnSubmit" runat="server" Text="Sign Up!" OnClick="btnSubmit_Click" OnClientClick="validate();"
          Enabled="false" />
      </div>
    </div>
