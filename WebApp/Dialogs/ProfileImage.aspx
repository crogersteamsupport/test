<%@ Page Title="" Language="C#" MasterPageFile="~/Dialogs/Dialog.master" AutoEventWireup="true" CodeFile="ProfileImage.aspx.cs" Inherits="Dialogs_ProfileImage" %>
...
<script  type="text/javascript">
    ...
    function linkUp(unusedIndex, container) {
        ...
        var keepRatio = true;// container.find('.keepAspectRatio').size() < 1 ? false : container.find('.keepAspectRatio').is(':checked');
...
<div class="dialogContentWrapperDiv">
    <div class="dialogContentDiv">
        ...
        <div class="image-cropper">
            ...
            <br />
                <asp:Image ID="imgCrop" runat="server" CssClass="image"  />
        ...
        <%--<div class="image-cropper">
            <img src="../images/flowers.jpg.ashx?height=200" class="image" />
            <div class="preview" style="float: left;margin-left: 3em">
            </div>
        </div>--%>
