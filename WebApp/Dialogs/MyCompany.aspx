    ...
    <div class="dialogContentWrapperDiv">
        <div class="dialogContentDiv">
            <table id="tblCustomControls" runat="server" width="775px" cellpadding="0" cellspacing="5"
                ...
                <tr>
                    <td class="labelColTD">Default Wiki Article:
                    </td>
                    <td class="inputColTD">
                ...
                <tr>
                    <td class="labelColTD">Default Font Family:
                    </td>
                    <td class="inputColTD">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadNumericTextBox ID="textPWExpire" runat="server" Width="197px" DataType="System.Int32" MinValue="0">
        ...
        -->
                ...
                <tr>
                    <td class="labelColTD" colspan="2">
                        <asp:CheckBox ID="cbHideDismissNonAdmins" runat="server" Text="Hide Alert Dismiss for Non Admins" /></td>
                    <td class="labelColTD" colspan="2">
                        <asp:CheckBox ID="cbUseProductFamilies" runat="server" Text="Use product lines" /></td>
                </tr>
                <tr>
                    <td class="labelColTD" colspan="2">
                        <asp:CheckBox ID="cbIsCustomerInsightsActive" runat="server" Text="Customer Insights" /></td>
                    <td class="labelColTD" colspan="2">
                        <asp:CheckBox ID="cbTwoStepVerification" runat="server" Text="Two Step Verification" /></td>
                </tr>
                <tr>
                    <td class="labelColTD" colspan="4">
                        <asp:CheckBox ID="cbNoAttachmentsInOutboundEmail" runat="server" Text="Do not include attachments on outbound emails" /></td>
                </tr>
                <tr>
                    <td class="labelColTD" colspan="4">
                        <asp:CheckBox ID="cbRequireGroupAssignmentOnTickets" runat="server" Text="Require a group assignment when creating or saving a ticket" /></td>
                </tr>
                <tr>
                    <td class="labelColTD" colspan="4">
                        <asp:CheckBox ID="cbAlertContactNoEmail" runat="server" Text="Warn if contact has no email address" /></td>
                </tr>
                <tr>
                    <td class="labelColTD" colspan="4">
                        <asp:CheckBox ID="cbDisableSupport" runat="server" Text="Allow TeamSupport to log into your account for technical support" /></td>
                </tr>
