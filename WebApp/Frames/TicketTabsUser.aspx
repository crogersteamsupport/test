<%@ Page Title="" Language="C#" MasterPageFile="~/FrameContainer.master" AutoEventWireup="true" CodeFile="TicketTabsUser.aspx.cs" Inherits="Frames_TicketTabsUser" %>
  ...
  <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
    <script type="text/javascript" language="javascript">
      function TabSelected(sender, args)
      {
        ...
        top.privateServices.SetUserSetting('SelectedUserTicketTabIndex' + window.location, tab.get_index());
      }
