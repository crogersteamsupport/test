<%@ Page Title="" Language="C#" MasterPageFile="~/Frames/Frame.master" AutoEventWireup="true" CodeFile="MasterHistory.aspx.cs" Inherits="Frames_MasterHistory" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdatePanelsRenderMode="Inline"></telerik:RadAjaxManager>
  ...
  <telerik:RadGrid ID="gridActionLogs" runat="server" Width="100%" Height="100%" AutoGenerateColumns="False" 
      ...
      <MasterTableView TableLayout="Fixed">
        <Columns>
          ...
          <telerik:GridBoundColumn DataField="Actor" HeaderText="Actor" UniqueName="Actor"></telerik:GridBoundColumn>
