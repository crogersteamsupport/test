<%@ Page Language="C#" MasterPageFile="~/Frames/Frame.master" AutoEventWireup="true" CodeFile="TicketTabs.aspx.cs" Inherits="Frames_TicketTabs" Title="Untitled Page" %>
  ...
  <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
    <script type="text/javascript" language="javascript">
      function TabSelected(sender, args) {
        showLoadingPanel("<%=ticketsFrame.ClientID %>");
