            ...
            <div style="padding-top: 3px;">
              ...
              <telerik:RadTabStrip ID="tsMain" runat="server" SelectedIndex="0" OnClientTabSelected="TabSelected" ShowBaseLine="True" Width="100%" PerTabScrolling="True" ScrollChildren="True">
                <Tabs>
                  ...
                  <telerik:RadTab runat="server" Value="../vcr/1_8_2/Pages/TicketGrid.html?tf_IsClosed=false&tf_GroupID=" Text="Open Tickets"></telerik:RadTab>
                  <telerik:RadTab runat="server" Value="../vcr/1_8_2/Pages/TicketGrid.html?tf_IsClosed=true&tf_GroupID=" Text="Closed Tickets"></telerik:RadTab>
                  <telerik:RadTab runat="server" Value="../vcr/1_8_2/Pages/TicketGrid.html?tf_IsClosed=false&tf_UserID=-2&tf_GroupID=" Text="Unassigned Tickets"></telerik:RadTab>
                  <telerik:RadTab runat="server" Value="../vcr/1_8_2/Pages/TicketGrid.html?tf_GroupID=" Text="All Tickets"></telerik:RadTab>
