      ...
      <div style="padding-top: 14px;">
       <telerik:RadTabStrip ID="tsMain" runat="server" SelectedIndex="1"  
         ...
         <Tabs>
           ...
           <telerik:RadTab runat="server" Selected="True" Text="Custom Fields" Value="../Resources_150/Pages/Admin_CustomFields.html"></telerik:RadTab>
           ...
           <telerik:RadTab runat="server" Text="Integration" Value="../Resources_150/Pages/Admin_Integration.html" Visible="true"></telerik:RadTab>
           <telerik:RadTab runat="server" Text="Ticket Templates" Value="AdminTicketTemplates.aspx"></telerik:RadTab>
           <telerik:RadTab runat="server" Text="Ticket Automation" Value="../Resources_150/Pages/Admin_Automation.html" Visible="true"></telerik:RadTab>
