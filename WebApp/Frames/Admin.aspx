      ...
      <div style="padding-top: 14px;">
       <telerik:RadTabStrip ID="tsMain" runat="server" SelectedIndex="1"  
         ...
         <Tabs>
           ...
           <telerik:RadTab runat="server" Text="My Portal" Value="../vcr/1_7_0/Pages/Admin_Portal.html" Visible="true"></telerik:RadTab>
           <telerik:RadTab runat="server" Selected="True" Text="Custom Fields" Value="../vcr/1_7_0/Pages/Admin_CustomFields.html"></telerik:RadTab>
           ...
           <telerik:RadTab runat="server" Text="Integration" Value="../vcr/1_7_0/Pages/Admin_Integration.html" Visible="true"></telerik:RadTab>
           <telerik:RadTab runat="server" Text="Ticket Templates" Value="AdminTicketTemplates.aspx"></telerik:RadTab>
           <telerik:RadTab runat="server" Text="Ticket Automation" Value="../vcr/1_7_0/Pages/Admin_Automation.html" Visible="true"></telerik:RadTab>
         </Tabs>
        </telerik:RadTabStrip>
       </div>
