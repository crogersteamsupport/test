...
public partial class Frames_Products : BaseFramePage
{
  ...
  private void SetNode(RadTreeNode node)
  {
    ...
    if (tsMain.SelectedIndex == 1)
    {
      if (versionID < 0)
        ...
        url = "../Resources_150/Pages/ProductVersion.html?VersionID=" + versionID.ToString();
    }
  ...
  private void CreateNavButtons()
  {
    ...
    tsMain.Tabs.Add(new RadTab("Version Information", "../Resources_150/Pages/ProductVersion.html?"));
