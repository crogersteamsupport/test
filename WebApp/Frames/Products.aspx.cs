...
public partial class Frames_Products : BaseFramePage
{
  ...
  private void SetNode(RadTreeNode node)
  {
    ...
    if (tsMain.SelectedIndex == 1)
    {
      if (versionID < 0)
        ...
        url = "../vcr/1_8_0/Pages/ProductVersion.html?VersionID=" + versionID.ToString();
    }
  ...
  private void CreateNavButtons()
  {
    ...
    tsMain.Tabs.Add(new RadTab("Version Information", "../vcr/1_8_0/Pages/ProductVersion.html?"));
    ...
    tsMain.Tabs.Add(new RadTab("Knowledge Base", "../vcr/1_8_0/Pages/TicketGrid.html?tf_IsKnowledgeBase=true&"));
