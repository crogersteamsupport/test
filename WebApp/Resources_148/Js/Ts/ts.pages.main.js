      ...
      switch (tab.getTabType()) {
        ...
        case Ts.Ui.Tabs.Tab.Type.Ticket:
          ...
          if (div.length < 1) {
            ...
            $('<iframe>')
              ...
              .attr('scrolling', 'no')
              .appendTo(div)
              .attr('src', 'Resources_148/Pages/Ticket.html?TicketNumber=' + tab.getId());
          }
          else {
            div.show();
          }
          $('.main-info-content').load('Resources_148/PaneInfo/ticket.html');
        ...
        case Ts.Ui.Tabs.Tab.Type.NewTicket:
          ...
          if (div.length < 1) {
            ...
            var nwLnk = showNewTicket ? 'Resources_148/Pages/NewTicket.html' : 'frames/newticket.aspx';
          ...
          $('.main-info-content').load('Resources_148/PaneInfo/newticket.html');
          break;
        default:
