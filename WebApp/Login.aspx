...
<body>
    ...
    <div class="container-fluid">
        <div class="card card-container">
            ...
            <h6 class="text-muted" style="text-align: center; margin-bottom: 0px; display:none;">Login attempt <span id="numbAttempts">2</span> of 10</h6>
            <form class="form-signin">
                ...
                <select id="orgSelect" class="form-control" style="display:none;"></select>
            ...
            <footer class="container">
                <div class="row">
                    ...
                    <div class="col-xs-6"><a id="mobile-link" href="http://m.teamsupport.com">Mobile Site</a></div>
                </div>
            </footer>
        </div>
    </div>
