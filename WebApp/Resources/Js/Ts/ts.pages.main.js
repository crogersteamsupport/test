...
Ts.Pages.Main.prototype =
{
  ...
  init: function () {
    ...
    $('.menu-help-docs').click(function () { top.Ts.System.logAction('Main Page - Help Docs Opened'); });
    $('.menu-help-chat').click(function () { top.Ts.System.logAction('Main Page - Help Chat Opened'); });
    $('.menu-help-support').click(function () { top.Ts.System.logAction('Main Page - Help Portal Opened'); });
    ...
    function getUserStatusUpdate() {
      ...
      Ts.Services.System.GetUserStatusUpdate(Ts.System.getSessionID(), function (result) {
        ...
        if (result != null) {
          ...
          if (result.IsExpired == true) { window.location = 'AnotherSession.aspx'; }
    ...
    function openTab(tab) {
      ...
      switch (tab.getTabType()) {
        case Ts.Ui.Tabs.Tab.Type.Main:
          ...
          try { if (parent.ticketSocket.server.ticketViewingRemove) parent.ticketSocket.server.ticketViewingRemove(null, top.Ts.System.User.UserID); } catch (err) { }
        ...
        case Ts.Ui.Tabs.Tab.Type.Ticket:
          ...
          if (div.length < 1) {
            ...
            try { if (parent.ticketSocket.server.getTicketViewing) parent.ticketSocket.server.getTicketViewing(ticketID); } catch (err) { }
          }
          $('.main-info-content').load('vcr/1_7_0/PaneInfo/ticket.html');
        ...
        case Ts.Ui.Tabs.Tab.Type.NewTicket:
          ...
          try { if (parent.ticketSocket.server.ticketViewingRemove) parent.ticketSocket.server.ticketViewingRemove(top.Ts.System.User.UserID); } catch (err) { }
