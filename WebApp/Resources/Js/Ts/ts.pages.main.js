...
Ts.Pages.Main.prototype = {
        ...
        case Ts.Ui.Tabs.Tab.Type.Ticket:
          ...
          if (div.length < 1) {
            ...
            $('<iframe>')
              ...
              .appendTo(div)
                        .attr('src', 'vcr/1_7_9/Pages/Ticket.html?TicketNumber=' + ticketID);
                    } else {
                        div.show();
                    ...
                    $('.main-info-content').load('vcr/1_7_9/PaneInfo/ticket.html');
          ...
          if (div.length < 1) {
            ...
            $('<iframe>')
              ...
              .attr('scrolling', 'no')
              .appendTo(div)
              .attr('src', 'vcr/1_7_9/Pages/NewTicket.html' + query);
          ...
          $('.main-info-content').load('vcr/1_7_9/PaneInfo/newticket.html');
          break;
          ...
          case Ts.Ui.Tabs.Tab.Type.NewCompany:
              ...
              if (div.length < 1) {
                  ...
                  $('<iframe>')
                    ...
                    .attr('scrolling', 'no')
                    .appendTo(div)
                    .attr('src', 'vcr/1_7_9/Pages/NewCustomer.html' + query);
              }
              else {
                  div.show();
              }
              $('.main-info-content').load('vcr/1_7_9/PaneInfo/customers.html');
              break;
          case Ts.Ui.Tabs.Tab.Type.Company:
              var OrgID = tab.getId();
              ...
              if (div.length < 1) {
                  ...
                  $('<iframe>')
                    ...
                    .appendTo(div)
                    .attr('src', 'vcr/1_7_9/Pages/CustomerDetail.html' + query);
              }
              else {
          ...
          case Ts.Ui.Tabs.Tab.Type.Contact:
              ...
              if (div.length < 1) {
                  ...
                  $('<iframe>')
                    ...
                    .appendTo(div)
                    .attr('src', 'vcr/1_7_9/Pages/ContactDetail.html' + query);
              }
              else {
              ...
              break;
                case Ts.Ui.Tabs.Tab.Type.Report:
                    ...
                    $('.main-info-content').load('vcr/1_7_9/PaneInfo/report.html');
  ...
  openNewCustomerNote: function (customerID, noteID) {
      ...
      top.Ts.Services.Organizations.GetShortNameFromID(customerID, function (result) {
        this.Ts.MainPage.MainTabs.prepend(true, Ts.Ui.Tabs.Tab.Type.Company, customerID, result, true, true, false, null, null, query, null);
        var element = $('.main-tab-content-item:visible');
        $(element).children('iframe').attr('src', 'vcr/1_7_9/Pages/CustomerDetail.html' + query);
      });
  },
  openNewContactNote: function (contactID, noteID) {
      ...
      top.Ts.Services.Users.GetShortNameFromID(contactID, function (result) {
        ...
        var element = $('.main-tab-content-item:visible');
        $(element).children('iframe').attr('src', 'vcr/1_7_9/Pages/ContactDetail.html' + query);
      });
  },
