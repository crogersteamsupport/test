...
$(document).ready(function () {
  _productVersionID = parent.Ts.Utils.getQueryValue("productversionid", window);
  ...
  parent.Ts.Services.Products.GetVersion(_productVersionID, function (productVersion) {
    if (productVersion == null)
    {
      //alert('This product version has either been deleted or you do not have permission to view it.');
      //parent.Ts.MainPage.closeNewProductVersionTab(_productVersionID);
    ...
    else
    {
      ...
      $('#fieldReleaseDate').text(parent.Ts.Utils.getMsDate(productVersion.ReleaseDateUTC).localeFormat(parent.Ts.Utils.getDatePattern()));

      parent.Ts.Services.Admin.GetIsJiraLinkActiveForOrganization(function (result) {
        if (result)
        {
      ...
      parent.privateServices.SetUserSetting('SelectedProductVersionID', _productVersionID);
    }
  });
  ...
  $('#productVersionEdit').click(function (e) {
    parent.Ts.System.logAction('Product Version Detail - Product Version Edit');
    $('.productVersionProperties p').toggleClass("editable");
    $('.productVersionProperties span').toggleClass("editable");
  ...
  $('#productVersionRefresh').click(function (e) {
    parent.Ts.System.logAction('Product Version Detail - Refresh Page');
  ...
  $('#productVersionDelete').click(function (e) {
    if (confirm('Are you sure you would like to remove this product version?')) {
      parent.Ts.System.logAction('Product Version Detail - Delete Product Version');
      parent.privateServices.DeleteVersion(_productVersionID, function (e) {
        parent.Ts.MainPage.closeNewProductVersionTab(_productVersionID);
      });
    }
  });
  ...
  function createTestChart() {
    ...
    parent.Ts.Services.Products.LoadVersionChartData(_productVersionID, true, function (chartString) {
    ...
    parent.Ts.Services.Products.LoadVersionChartData(_productVersionID, false, function (chartString) {
  ...
  parent.Ts.Services.Products.GetProductVersionTickets(_productVersionID, 0, function (e) {
      $('#openTicketCount').text("Open Tickets: " + e);
  });

  parent.Ts.Services.Tickets.Load5MostRecentByProductVersionID(_productVersionID, function (tickets) {
      var max = 5;
      if (tickets.length < 5)
          max = tickets.length;
  ...
  function LoadCustomProperties() {
    parent.Ts.Services.Assets.GetCustomValues(_productVersionID, parent.Ts.ReferenceTypes.ProductVersions, function (html) {
  ...
  $('#historyToggle').on('click', function () {
      parent.Ts.System.logAction('Product Version Detail - History Toggle');
      if (historyLoaded == 0) {
          historyLoaded = 1;
          LoadHistory(1);
      }
  ...
  $('#historyRefresh').on('click', function () {
      parent.Ts.System.logAction('Product Version Detail - History Refresh');
          LoadHistory(1);
  });
  ...
  function LoadHistory(start) {
      ...
      if(start == 1)
          ...
          parent.Ts.Services.Products.LoadVersionHistory(_productVersionID, start, function (history) {
  ...
  $('#productVersionNumber').click(function (e) {
      ...
      parent.Ts.System.logAction('Product Version Detail - Edit Version Number');
      ...
      $('<i>')
        ...
        .click(function (e) {
            parent.Ts.System.logAction('Product Version Detail - Save Version Number Edit');
            parent.Ts.Services.Products.SetVersionNumber(_productVersionID, $(this).prev().find('input').val(), function (result) {
                header.text(result);
  ...
  $('#fieldDescription').click(function (e) {
      ...
      parent.Ts.System.logAction('Product Version Detail - Edit Description');
      parent.Ts.Services.Products.GetVersion(_productVersionID, function (productVersion) {
      ...
      $('#btnDescriptionSave').click(function (e) {
        e.preventDefault();
        parent.Ts.System.logAction('Product Version Detail - Save Description Edit');
        parent.Ts.Services.Products.SetVersionDescription(_productVersionID, $(this).prev().find('textarea').val(), function (result) {
            header.html(result);
  ...
  $('#fieldProduct').click(function (e) {
    e.preventDefault();
    parent.Ts.System.logAction('Product Version Detail - View Product');
    parent.Ts.MainPage.openNewProduct(_productID);

    parent.Ts.Services.Products.UpdateRecentlyViewed('p' + _productID, function (resultHtml) {
    });
  });
  ...
  $('#fieldStatus').click(function (e) {
      ...
      if (!$(this).hasClass('editable'))
          return false;
      var header = $(this).hide();
      parent.Ts.System.logAction('Product Version Detail - Edit Status');
      var container = $('<div>')
        .insertAfter(header);
      ...
      parent.Ts.Services.Products.LoadVersionStatuses(function (statuses) {
      ...
      $('#ddlStatus').on('change', function () {
          ...
          container.remove();
          parent.Ts.System.logAction('Product Version Detail - Save Status');
          parent.Ts.Services.Products.SetProductVersionStatus(_productVersionID, value, function (result) {
  ...
  $('#fieldJiraProjectKey').click(function (e) {
    ...
    parent.Ts.System.logAction('Product Version Detail - Edit Jira Project Key');
    var header = $(this).hide();
    var container = $('<div>')
      .insertAfter(header);
    ...
    $('<i>')
      .addClass('col-xs-1 fa fa-check')
      .click(function (e) {
        parent.Ts.System.logAction('Product Version Detail - Save Jira Project Key Edit');
        var isForProductVersion = true;
        parent.Ts.Services.Products.SetProductJiraProjectKey(_productVersionID, $(this).prev().find('input').val(), isForProductVersion, function (result) {
          header.text(result);
  ...
  $('#fieldReleased').click(function (e) {
      if (!$(this).hasClass('editable'))
          return false;
      parent.Ts.Services.Products.SetProductVersionReleased(_productVersionID, ($(this).text() !== 'True'), function (result) {
          parent.Ts.System.logAction('Product Version Detail - Toggle Released State');
  ...
  $('#fieldReleaseDate').click(function (e) {
    ...
    if (!$(this).hasClass('editable'))
      return false;
    parent.Ts.System.logAction('Product Version Detail - Date Released clicked');
    ...
    $('<i>')
          ...
          .click(function (e) {
            ...
            parent.show();
            $('#productVersionEdit').removeClass("disabled");
            parent.Ts.System.logAction('Product Version Detail - Date Released change cancelled');
          })
          .insertAfter(container1);
    $('<i>')
          .addClass('col-xs-1 fa fa-check')
          .click(function (e) {
            ...
            container.remove();
            parent.Ts.Services.Products.SetReleaseDate(_productVersionID, value, function (result) {
              ...
              $('#productVersionEdit').removeClass("disabled");
              parent.Ts.System.logAction('Product Version Detail - Date Released Change');
            },
            function (error) {
              parent.show();
  ...
  if (!parent.Ts.System.User.CanEditVersions && !_isAdmin) {
  ...
  $('#customerToggle').click(function (e) {
      parent.Ts.System.logAction('Product Version Detail - Toggle Customer Form');
      $('#customerForm').toggle();
  });

  $('#associateAllToggle').click(function (e) {
      if (confirm('Are you sure you would like to associate All customers to this version?')) {
        parent.Ts.System.logAction('Product Version Detail - Toggle Associate All Customer Form');
        parent.Ts.Services.Customers.AssignAllCustomersToVersion(_productVersionID, function () {
            LoadCustomers();
        }, function () {
  ...
  $('#unAssociateAllToggle').click(function (e) {
      if (confirm('Are you sure you would like to unassociate All customers from this version?')) {
        parent.Ts.System.logAction('Product Version Detail - Toggle Unassociate All Customer Form');
        parent.Ts.Services.Customers.UnassignAllCustomersFromVersion(_productVersionID, function () {
            LoadCustomers();
        }, function () {
  ...
  function LoadCustomers(start) {
      ...
      parent.Ts.Services.Products.LoadVersionCustomers(_productVersionID, start, _customersSortColumn, _customersSortDirection, function (customers) {
  ...
  $('.product-version-customers-export-excel').on('click', function (e) {
      ...
      parent.Ts.System.logAction('Product Version Detail Page - Export Customers Excel');

      window.open('../../../dc/' + parent.Ts.System.Organization.OrganizationID + '/productversioncustomers/' + _productVersionID + '?Type=EXCEL', 'ProductCustomersDownload');
  ...
  $('.product-version-customers-export-csv').on('click', function (e) {
      ...
      parent.Ts.System.logAction('Product Version Detail Page - Export Customers CSV');

      window.open('../../../dc/' + parent.Ts.System.Organization.OrganizationID + '/productversioncustomers/' + _productVersionID + '?Type=CSV', 'ProductCustomersDownload');
  ...
  $('#btnCustomerSave').click(function (e) {
      e.preventDefault();
      e.stopPropagation();
      parent.Ts.System.logAction('Product Version Detail - Save Customer');
  ...
  $("#btnCustomerCancel").click(function (e) {
      e.preventDefault();
      parent.Ts.System.logAction('Product Version Detail - Cancel Customer Edit');
      $('#productExpiration').val('');
      $('#fieldOrganizationProductID').val('-1');
      $('.customField:visible').each(function () {
          switch ($(this).attr("type")) {
  ...
  $('#tblCustomers').on('click', '.customerEdit', function (e) {
      ...
      //var orgproductID;
      parent.Ts.System.logAction('Product Version Detail - Edit Customer');
  ...
  $('#tblCustomers').on('click', '.customerDelete', function (e) {
      ...
      if (confirm('Are you sure you would like to remove this customer association?')) {
          parent.Ts.System.logAction('Product Version Detail - Delete Customer');
  ...
  $('#tblCustomers').on('click', '.customerView', function (e) {
      e.preventDefault();
      parent.Ts.System.logAction('Product Version Detail - View Customer');
  ...
  function LoadFiles() {
      ...
      parent.Ts.Services.Customers.LoadFiles(_productVersionID, parent.Ts.ReferenceTypes.ProductVersions, function (files) {
  ...
  $('#fileToggle').click(function (e) {
      parent.Ts.System.logAction('Product Version Detail - Toggle File Form');
      $('#fileForm').toggle();
  });

  $("#btnFilesCancel").click(function (e) {
      parent.Ts.System.logAction('Product Version Detail - Cancel File Form');
      $('.upload-queue').empty();
  ...
  $('#btnFilesSave').click(function (e) {
      parent.Ts.System.logAction('Product Version Detail - Save Files');
  ...
  function LoadInventory(start) {
      ...
      parent.Ts.Services.Products.LoadVersionAssets(_productVersionID, start, function (assets) {
  ...
  $('.assetList').on('click', '.assetLink', function (e) {
      e.preventDefault();
      parent.Ts.System.logAction('Product Version Detail - Open Asset From List');
  ...
  var result = $('<p>')
      ...
      .click(function (e) {
        ...
        if (!$(this).hasClass('editable'))
          return false;
        var parent = $(this).hide();
        parent.Ts.System.logAction('Product Version Detail - Edit Custom Combobox');
        var container = $('<div>')
            .insertAfter(parent);
        ...
        $('#' + field.Name.replace(/\W/g, '')).on('change', function () {
          ...
          if (field.IsRequired && field.IsFirstIndexSelect == true && $(this).find('option:selected').index() < 1) {
            ...
            parent.Ts.System.logAction('Product Version Detail - Save Custom Edit Change');
            parent.Ts.Services.System.SaveCustomValue(field.CustomFieldID, _productVersionID, value, function (result) {
  ...
  var result = $('<p>')
      ...
      .click(function (e) {
        ...
        if (!$(this).hasClass('editable'))
          return false;
        var parent = $(this).hide();
        parent.Ts.System.logAction('Product Version Detail - Edit Custom Number');
        var container = $('<div>')
            .insertAfter(parent);
        ...
        $('<i>')
            ...
            .click(function (e) {
              ...
              if (field.IsRequired && (value === null || $.trim(value) === '')) {
                ...
                parent.Ts.System.logAction('Product Version Detail - Save Custom Number Edit');
                parent.Ts.Services.System.SaveCustomValue(field.CustomFieldID, _productVersionID, value, function (result) {
                  parent.closest('.form-group').data('field', result);
                  parent.text((result.Value === null || $.trim(result.Value) === '' ? 'Unassigned' : result.Value));
                  $('#productEdit').removeClass("disabled");
...
var appendCustomEditBool = function (field, element) {
  ...
  var result = $('<p>')
      ...
      .click(function (e) {
        ...
        parent.Ts.System.logAction('Product Version Detail - Edit Custom Boolean Value');
        var parent = $(this);
      ...
      .click(function (e) {
        if ($(this).has('a') && !$(this).hasClass('editable')) {
          ...
          if (!$(this).hasClass('editable'))
            return false;
          var parent = $(this).hide();
          parent.Ts.System.logAction('Product Version Detail - Edit Custom Textbox');
          var container = $('<div>')
                .insertAfter(parent);
          ...
          $('<i>')
                ...
                .click(function (e) {
                  ...
                  if (field.IsRequired && (value === null || $.trim(value) === '')) {
                    ...
                    parent.Ts.System.logAction('Product Version Detail - Save Custom Textbox Edit');
                    parent.Ts.Services.System.SaveCustomValue(field.CustomFieldID, _productVersionID, value, function (result) {
                      parent.closest('.form-group').data('field', result);
  ...
  var result = $('<p>')
      ...
      .click(function (e) {
        ...
        if (!$(this).hasClass('editable'))
          return false;
        var parent = $(this).hide();
        parent.Ts.System.logAction('Product Version Detail - Edit Custom Date');
        var container = $('<div>')
            .insertAfter(parent);
        ...
        $('<i>')
            ...
            .click(function (e) {
              ...
              if (field.IsRequired && (value === null || $.trim(value) === '')) {
                ...
                parent.Ts.System.logAction('Product Version Detail - Save Custom Date Change');
                parent.Ts.Services.System.SaveCustomValue(field.CustomFieldID, _productVersionID, value, function (result) {
                  parent.closest('.form-group').data('field', result);
  ...
  var result = $('<p>')
      ...
      .click(function (e) {
        ...
        if (!$(this).hasClass('editable'))
          return false;
        var parent = $(this).hide();
        parent.Ts.System.logAction('Product Version Detail - Edit Custom DateTime');
        var container = $('<div>')
            .insertAfter(parent);
        ...
        $('<i>')
            ...
            .click(function (e) {
              ...
              if (field.IsRequired && (value === null || $.trim(value) === '')) {
                ...
                parent.Ts.System.logAction('Product Version Detail - Save Custom DateTime');
                parent.Ts.Services.System.SaveCustomValue(field.CustomFieldID, _productVersionID, value, function (result) {
                  parent.closest('.form-group').data('field', result);
                  var date = result.Value === null ? null : parent.Ts.Utils.getMsDate(result.Value);
  ...
  var result = $('<p>')
      ...
      .click(function (e) {
        ...
        if (!$(this).hasClass('editable'))
          return false;
        var parent = $(this).hide();
        parent.Ts.System.logAction('Product Version Detail - Edit Custom Time');
        var container = $('<div>')
            .insertAfter(parent);
        ...
        $('<i>')
            ...
            .click(function (e) {
              ...
              if (field.IsRequired && (value === null || $.trim(value) === '')) {
                ...
                parent.Ts.System.logAction('Product Version Detail - Save Custom Time');
                parent.Ts.Services.System.SaveCustomValue(field.CustomFieldID, _productVersionID, value, function (result) {
                  parent.closest('.form-group').data('field', result);
                  var date = result.Value === null ? null : parent.Ts.Utils.getMsDate(result.Value);
