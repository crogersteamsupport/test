...
function GetSearchResults() {
    ...
    if (window.parent._activeChatID) {
        chatID = window.parent._activeChatID;
    }
    mainFrame.Ts.Services.Chat.GetSuggestedSolutions(chatID, _firstItemIndex, _pageSize, function (results) { showSearchResults(results); });
