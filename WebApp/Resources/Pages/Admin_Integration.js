...
AdminInt = function () {
  parent.Ts.Services.Organizations.GetSlaLevels(function (result) {
    slaLevels = result;
  });

  actionTypes = parent.Ts.Cache.getActionTypes();

	parent.Ts.Services.Tickets.GetTicketStatusesOrderedByTicketTypeName(function (result) {
		organizationStatuses = result;
	});

  ticketTypes = parent.Ts.Cache.getTicketTypes();
  ...
  parent.Ts.Services.Organizations.GetCrmLinks(function (result) {
  ...
  $('#int-api-new').click(function (e) {
    ...
    if (confirm('Are you sure you would like to generate a new API token?' + '\n' + 'You will need to replace the token in all the applications that use the TeamSupport API.')) {
      parent.Ts.Services.Organizations.GenerateNewApiToken(loadApiInfo);
      parent.Ts.System.logAction('Admin Integration - API Token Generated');
  ...
  $('#int-api-enable').click(function (e) {
    e.preventDefault();
    parent.Ts.Services.Organizations.SetApiEnabled(true, loadApiInfo);
    parent.Ts.System.logAction('Admin Integration - API Toggled');
  });

  $('#int-api-disable').click(function (e) {
    e.preventDefault();
    parent.Ts.Services.Organizations.SetApiEnabled(false, loadApiInfo);
    parent.Ts.System.logAction('Admin Integration - API Toggled');
  });
  ...
  $('.int-api-link-users').click(function (e) {
    ...
    if (info.IsEnabled === false) {
      if (confirm('You must have your API enabled before you can use it.' + '\n' + 'Would you like to enabled it now?')) {
        parent.Ts.Services.Organizations.SetApiEnabled(true, function (result) {
          loadApiInfo(result);
  ...
  function loadApiInfo(info) {
    if (info.IsActive === true) {
      ...
      var link = 'https://' + parent.Ts.System.Organization.OrganizationID + ':' + info.Token + '@'+ parent.Ts.System.AppDomain + '/api/xml/users';
  ...
  parent.Ts.Services.Organizations.GetApiInfo(loadApiInfo);
  ...
  function loadMaps(element) {
    ...
    parent.Ts.Services.Organizations.GetCrmLinkFields(data.CRMLinkID, function (fields) {
    ...
    if ($('.int-map-type option').length < 1) {
      $('<option>')
        .text('Account')
        .attr('value', parent.Ts.ReferenceTypes.Organizations)
        .attr('selected', 'selected')
        .appendTo('.int-map-type');

      $('<option>')
        .text('Contact')
        .attr('value', parent.Ts.ReferenceTypes.Contacts)
        .appendTo('.int-map-type');

      $('<option>')
        .text('Ticket')
        .attr('value', parent.Ts.ReferenceTypes.Tickets)
        .appendTo('.int-map-type');
  ...
  function loadFields(select, refType) {
    select.empty();
    parent.Ts.Services.CustomFields.GetAllFields(refType, null, false, function (fields) {
    ...
    $('<span>')
      ...
      .click(function (e) {
        ...
        if (confirm('Are you sure you would like to delete this mapping?')) {
          parent.Ts.Services.Organizations.DeleteCrmLinkField(div.data('field').CRMFieldID, function () {
            div.remove();
            parent.Ts.System.logAction('Admin Integration - CRM Mapping Deleted');
          });
        }
  ...
  $('.map-add').click(function (e) {
    ...
    parent.Ts.Services.Organizations.SaveCrmLinkField(
    ...
    parent.Ts.System.logAction('Admin Integration - CRM Mapping Added');
  ...
  $('.jira-map-add').click(function (e) {
    ...
    parent.Ts.System.logAction('Admin Integration - Jira Mapping Added');
  ...
  $('.zoho-map-add').click(function (e) {
    ...
    parent.Ts.System.logAction('Admin Integration - ZohoCRM Mapping Added');
  ...
  $('.int-type').delegate('.int-save', 'click', function (e) {
    ...
    parent.Ts.Services.Organizations.SaveCrmLink(
          linkID,
          ...
          function (result) {
            ...
            parent.Ts.System.logAction('Admin Integration - Settings Saved');
          },
          function () {
