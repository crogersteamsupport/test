...
AdminPortal = function () {
  ...
  $('.com-enable').click(function (e) {
    ...
    parent.Ts.Services.Organizations.UpdateUseCommunity($(this).text().indexOf('Enable') > -1, function (result) {
      if (result != null) {
        parent.Ts.System.logAction('Admin Portal - Community Toggled');
  ...
  function getData() {
    parent.Ts.Services.Organizations.GetOrganization(parent.Ts.System.Organization.OrganizationID, function (org) {
      organization = org;
      parent.Ts.Services.Organizations.GetPortalOption(organization.OrganizationID, function (po) {
        parent.Ts.Settings.clearCache();
        parent.Ts.Settings.Organization.read('ExternalPortalLink', '', function (externalLink) {
          _portalOption = po;
  ...
  function loadValues(organization, portalOption, externalLink) {
    ...
    $('#portal_adv_url').text(parent.Ts.System.PortalDomain + '/' + portalOption.PortalName).attr('href', parent.Ts.System.PortalDomain + '/' + portalOption.PortalName);
    ...
    var domain = parent.Ts.System.Domain;
  ...
  function saveValues(portalOption) {
    ...
    var _agentratingOption = new parent.TeamSupport.Data.AgentRatingsOptionProxy();;
    ...
    parent.Ts.Services.Organizations.SetPortalOption(portalOption, $('#portal_external_link').val(), $('#portal_allow_wiki').prop('checked'), $('#portal_def_group').val() == -1 ? null : $('#portal_def_group').val(), _agentratingOption, function (result) {
      if (result != null) {
        alert(result);
      }
      else {
        parent.Ts.System.logAction('Admin Portal - Portal Settings Saved');
        $('.portal-save-panel').hide();
      }
    });
  ...
  function getForumCats() {
    parent.Ts.Services.Admin.GetForumCategories(function (cats) {
      $('.com-cat-list').empty();
  ...
  $('.com-delete-cat').click(function (e) {
    ...
    parent.Ts.System.logAction('Admin Portal - Category Deleted');
    parent.Ts.Services.Admin.DeleteForumCategory(cat.CategoryID, function (result) {
  ...
  $('.com-save-cat').click(function (e) {
    ...
    if (el.length < 1) return;
    var cat = el.data('cat');
    parent.Ts.System.logAction('Admin Portal - Category Saved');
    parent.Ts.Services.Admin.UpdateForumCategory(
      cat.CategoryID,
      $('#com_cat_name').val(),
  ...
  $('.com-new-cat').click(function (e) {
    e.preventDefault();
    parent.Ts.Services.Admin.AddForumCategory(null, function (result) {
      if (result != null) {

        var el = createCategory(result);
        el.click();
        $('.com-no-cat').hide().next().show();
        parent.Ts.System.logAction('Admin Portal - Category Created');
      }
    });
  });
  ...
  $('.com-cat-list').delegate('.com-new-sub', 'click', function (e) {
    ...
    parent.Ts.Services.Admin.AddForumCategory(parentCat.CategoryID, function (result) {
      if (result != null) {
  ...
  function savePositions() {
    ...
    $('.com-cats').each(function () {
      ...
      var item = new Object(); // parent.TSWebServices.ForumCategoryOrder();
      item.CategoryIDs = new parent.Array();
    ...
    parent.Ts.Services.Admin.UpdateForumCategoryOrder(JSON.stringify(orders));
    parent.Ts.System.logAction('Admin Portal - Category Positions Changed');
  }

  getKnowledgeBaseCats()
  function getKnowledgeBaseCats() {
    parent.Ts.Services.Admin.GetKnowledgeBaseCategories(function (cats) {
      $('.kb-cat-list').empty();
      for (var i = 0; i < cats.length; i++) {
        var cat = cats[i].Category;
  ...
  $('.kb-delete-cat').click(function (e) {
    ...
    parent.Ts.System.logAction('Admin Portal - KnowledgeBase Category Deleted');
    parent.Ts.Services.Admin.DeleteKnowledgeBaseCategory(cat.CategoryID, function (result) {
      if (result == false) return;
  ...
  $('.kb-save-cat').click(function (e) {
    ...
    if (el.length < 1) return;
    var cat = el.data('cat');
    parent.Ts.System.logAction('Admin Portal - KnowledgeBase Category Saved');
    parent.Ts.Services.Admin.UpdateKnowledgeBaseCategory(
      cat.CategoryID,
      $('#kb_cat_name').val(),
  ...
  $('.kb-new-cat').click(function (e) {
    e.preventDefault();
    parent.Ts.Services.Admin.AddKnowledgeBaseCategory(null, function (result) {
      if (result != null) {
        var el = createKnowledgeBaseCategory(result);
        el.click();
        $('.kb-no-cat').hide().next().show();
        parent.Ts.System.logAction('Admin Portal - KnowledgeBase Category Created');
  ...
  $('.kb-cat-list').delegate('.kb-new-sub', 'click', function (e) {
    ...
    parent.Ts.Services.Admin.AddKnowledgeBaseCategory(parentCat.CategoryID, function (result) {
      if (result != null) {
  ...
  function saveKnowledgeBasePositions() {
    ...
    parent.Ts.Services.Admin.UpdateKnowledgeBaseCategoryOrder(JSON.stringify(orders));
    parent.Ts.System.logAction('Admin Portal - KnowledgeBase Category Positions Changed');
  ...
  {
      parent.Ts.Services.Organizations.LoadCustomPortalColumns(parent.Ts.System.Organization.OrganizationID, function(columns){
  ...
  function appendCustomPortalColumn(col)
  {
      ...
      var trash = $('<span>').addClass('ts-icon ts-icon-delete').hide().click(function () {
          if (confirm("Do you want to delete this column?")) {
              parent.Ts.Services.Organizations.RemoveCustomPortalColumn(sort.data("fieldID"));
              sort.remove();
              parent.Ts.System.logAction('Admin Portal - Grid Column Removed');
          }
      }).appendTo(sort);
  }
  ...
  $('.add-portal-column').click(function () {
      ...
      if (!isDupe)
      {
          ...
          parent.Ts.Services.Organizations.AddCustomPortalColumn($('.admin-portal-columns').val(), $('.sort-item').length);
          parent.Ts.System.logAction('Admin Portal - Grid Column Added');
      }
  ...
  function savePortalColPositions() {
      ...
      parent.Ts.System.logAction('Admin Portal - Grid Column Order Saved');
      parent.Ts.Services.Organizations.SavePortalColOrder(JSON.stringify(items));
  }
  ...
  $('#resetPositiveImage').click(function () {
      parent.Ts.Services.Organizations.ResetRatingImage(1, function () {
  ...
  $('#resetNeutralImage').click(function () {
      parent.Ts.Services.Organizations.ResetRatingImage(0, function () {
  ...
  function buildWidgetCode() {
  	var defaultString = "<script src='"+ parent.Ts.System.AppDomain + "/widget.js'></script>\n";
      var options = "";
      if ($('#widget-width').val() != '')
      {
      ...
      var appendString = "<script>TeamSupport.Widget({orgID: " + parent.Ts.System.Organization.OrganizationID + options +"'}); </script>";
  ...
  $('#recalculate-cdi').click(function () {
      parent.Ts.Services.Organizations.ResetCDI();
      $(this).hide();
  });
};
