...
AdminPortal = function () {
  ...
  function saveValues() {
    ...
    var _cdiOption = new parent.TeamSupport.Data.CDI_SettingProxy();
    ...
    parent.Ts.Services.Organizations.SaveCDISettings(_cdiOption, function (result) {
        parent.Ts.System.logAction('Admin Company - CDI Settings Saved');
        $('.portal-save-panel').hide();
    });
          ...
          if (cdi != null)
            {
              ...
              var lastCompute = cdi.LastCompute == null ? 'Never' : parent.Ts.Utils.getMsDate(cdi.LastCompute);
              ...
              {
                  var cdistatus = lastCompute.localeFormat(parent.Ts.Utils.getDateTimePattern())
              }
