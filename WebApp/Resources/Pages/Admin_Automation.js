...
AdminAuto = function () {
  ...
  $('.trigger-save').click(function (e) {
    ...
    parent.Ts.Services.Automation.SaveTrigger(JSON.stringify(data), function (trigger) {
      isModified(false);
      ...
      parent.Ts.System.logAction('Admin Automation - Trigger Saved');
    });
  });
  ...
  function newTrigger(e) {
    ...
    hideNoTrigger();
    clearTrigger();
    parent.Ts.System.logAction('Admin Automation - Started New Trigger');
  }
  ...
  function duplicateTrigger(e) {
  	...
  	$('#cmbEnable').val(0);
  	parent.Ts.System.logAction('Admin Automation - Trigger Duplicated');
  }
  ...
  addToolbarButton('btnDelete', 'ts-icon-delete', 'Delete Trigger', function (e) {
    ...
    parent.Ts.Services.Automation.DeleteTrigger(getSelectedTriggerID(), function () {
      ...
      parent.Ts.System.logAction('Admin Automation - Trigger Deleted');
    });
  ...
  parent.Ts.Services.Automation.GetData(function (data) {
    _data = data;
    loadTriggers();
  });
  ...
  function loadTriggers(triggerID) {
    parent.Ts.Services.Automation.GetTriggers(function (result) {
      if (result.length > 0) {
  ...
  function loadTrigger() {
    ...
    parent.Ts.Services.Automation.GetTrigger(_triggerID, function (result) {
  ...
  $('#btnAddAllCondition').click(function (e) {
    ...
    parent.Ts.System.logAction('Admin Automation - All Condition Added');
  });

  $('#btnAddAnyCondition').click(function (e) {
    e.preventDefault();
    addCondition('.conditions-any');
    parent.Ts.System.logAction('Admin Automation - Any Condition Added');
  });
  ...
  function addCondition(selector, fieldID, measure, value) {
    ...
    $('<span>').addClass('ts-icon ts-icon-remove').appendTo(div).click(function (e) {
      $(this).parent().remove(); isModified(true); parent.Ts.System.logAction('Admin Automation - Condition Removed');
    });
  ...
  function getLogic() {
    ...
    function getItems(selector, isAny, items) {
      $(selector).find('.condition').each(function () {
        proxy = new parent.TeamSupport.Data.TicketAutomationTriggerLogicItemProxy();
        proxy.TriggerID = -1;
  ...
  $('#btnAddAction').click(function (e) {
    e.preventDefault();
    addAction('.actions');
    parent.Ts.System.logAction('Admin Automation - Action Added');
  ...
  function addAction(selector, actionID, value1, value2) {
    ...
    $('<span>').addClass('ts-icon ts-icon-remove').appendTo(main).click(function (e) {
      $(this).parents('.action').remove(); isModified(true); parent.Ts.System.logAction('Admin Automation - Action Removed');
    });
  ...
  function getActions() {
    ...
    $('.actions .action').each(function (index) {
      proxy = new parent.TeamSupport.Data.TicketAutomationActionProxy();
      proxy.TriggerID = -1;
    ...
    switch (action.ValueList) {
      ...
      case 'TextBox':
        ...
        if (action.ValueList == 'CustomerList') {
            ...
            parent.Ts.Services.Organizations.GetOrganization(value1, function (result) {
                if (result) {
            ...
            parent.Ts.Services.Organizations.GetUser(value1, function (result) {
                if (result) {
  ...
  function getCompanies(request, response) {
      ...
      execGetCompany = parent.Ts.Services.Organizations.GetCompanies(request.term, function (result) { response(result); });
      isModified(true);
  }
  ...
  function getContacts(request, response) {
      ...
      execGetContact = parent.Ts.Services.Organizations.GetContacts(request.term, function (result) { response(result); });
      isModified(true);
  }
