...
AdminAuto = function () {
  ...
  $('.trigger-save').click(function (e) {
    ...
    var data = new top.TSWebServices.SaveTriggerData();
    ...
    top.Ts.Services.Automation.SaveTrigger(data, function (trigger) {
      isModified(false);
  ...
  function addAction(selector, actionID, value1, value2) {
    ...
    function onEditorInit(ed) {
      ...
      setActionValues(div, selectedAction);
  ...
  function setActionValues(element, action) {
