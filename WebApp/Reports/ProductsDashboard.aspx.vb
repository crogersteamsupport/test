...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        TicketsByProduct.Attributes.Add("src", DisplayOpenTicketsByProduct("1078"))
    ...
    Protected Sub TicketsCreatedPerDay_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceSelectingEventArgs) Handles OpenTicketsByProduct.Selecting
    ...
    Public Function DisplayOpenTicketsByProduct(ByVal OrganizationID As String) As String
        ...
        Try
            ...
            Dim HTMLString As String = CreatePiefromTable(table, "Open+Tickets")
