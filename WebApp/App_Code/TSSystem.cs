  ...
  public class TSSystem : System.Web.Services.WebService
  {
    ...
    public TsMenuItem[] GetMainMenuItems()
    {
      ...
      if (org.ParentID != null)
      {
        ...
        items.Add(new TsMenuItem("dashboard", "mniDashboard", "Dashboard", "images/nav/16/Dashboard.png", string.Format(data, "Frames/Dashboard.aspx", "Resources_141/PaneInfo/Dashboard.html")));


        TsMenuItem ticketItem = new TsMenuItem("tickets", "mniTickets", "Tickets", "images/nav/16/tickets.png", string.Format(data, "Resources_141/Pages/TicketTabs.html", "Resources_141/PaneInfo/Tickets.html"));
        items.Add(ticketItem);

        ticketItem.AddItem(new TsMenuItem("mytickets", "mniMyTickets", "My Tickets", "images/nav/16/mytickets.png", string.Format(data, "Resources_141/Pages/TicketTabs.html?UserID=" + TSAuthentication.UserID, "Resources_141/PaneInfo/MyTickets.html")));
        ticketItem.AddItem(new TsMenuItem("tickettags", "mniTicketTags", "Ticket Tags", "images/nav/16/tag.png", string.Format(data, "Frames/TicketTags.aspx", "Resources_141/PaneInfo/TicketTags.html")));
        ...
        {
          ticketItem.AddItem(new TsMenuItem("tickettype", "mniTicketType_" + ticketType.TicketTypeID.ToString(), ticketType.Name, ticketType.IconUrl, string.Format(data, "Resources_141/Pages/TicketTabs.html?TicketTypeID=" + ticketType.TicketTypeID.ToString(), "Resources_141/PaneInfo/Tickets.html")));
        }

        items.Add(new TsMenuItem("kb", "mniKB", "Knowledge Base", "images/nav/16/knowledge.png", string.Format(data, "Frames/KnowledgeBase.aspx", "Resources_141/PaneInfo/Knowledge.html")));
        ...
        if (org.ProductType != ProductType.Express)
        {
          ...
          items.Add(new TsMenuItem("wiki", "mniWiki", "Wiki", "images/nav/16/wiki.png", string.Format(data, wikiLink, "Resources_141/PaneInfo/Wiki.html")));
        }

        items.Add(new TsMenuItem("search", "mniSearch", "Search", "images/nav/16/search.png", string.Format(data, "Frames/Search.aspx", "Resources_141/PaneInfo/Search.html")));

        if (user.IsChatUser && org.ChatSeats > 0)
        {
          items.Add(new TsMenuItem("chat", "mniChat", "Chat", "images/nav/16/chat.png", string.Format(data, "Frames/Chat.aspx", "Resources_141/PaneInfo/Chat.html")));
        }

        if (org.ProductType != ProductType.Express)
          items.Add(new TsMenuItem("wc", "mniWC", "Water Cooler", "images/nav/16/watercooler.png", string.Format(data, "WaterCooler/WaterCooler.aspx", "Resources_141/PaneInfo/WaterCooler.html")));
        items.Add(new TsMenuItem("users", "mniUsers", "Users", "images/nav/16/users.png", string.Format(data, "Frames/Users.aspx", "Resources_141/PaneInfo/Users.html")));
        items.Add(new TsMenuItem("groups", "mniGroups", "Groups", "images/nav/16/groups.png", string.Format(data, "Frames/Groups.aspx", "Resources_141/PaneInfo/Groups.html")));
        if (org.ProductType == ProductType.Enterprise || org.ProductType == ProductType.HelpDesk)
          items.Add(new TsMenuItem("customers", "mniCustomers", "Customers", "images/nav/16/customers.png", string.Format(data, "Frames/Organizations.aspx", "Resources_141/PaneInfo/Customers.html")));
        if (org.ProductType == ProductType.Enterprise || org.ProductType == ProductType.BugTracking)
          items.Add(new TsMenuItem("products", "mniProducts", "Products", "images/nav/16/products.png", string.Format(data, "Frames/Products.aspx", "Resources_141/PaneInfo/Products.html")));
        if (org.IsInventoryEnabled)
          items.Add(new TsMenuItem("inventory", "mniInventory", "Inventory", "images/nav/16/inventory.png", string.Format(data, "Inventory/Inventory.aspx", "Resources_141/PaneInfo/Inventory.html")));
      ...
      {
        items.Add(new TsMenuItem("tsusers", "mniUsers", "System Users", "images/nav/16/users.png", string.Format(data, "Frames/Users.aspx", "Resources_141/PaneInfo/Users.html")));
        items.Add(new TsMenuItem("tscustomers", "mniCustomers", "System Customers", "images/nav/16/customers.png", string.Format(data, "Frames/Organizations.aspx", "Resources_141/PaneInfo/Organizations.html")));
      }
