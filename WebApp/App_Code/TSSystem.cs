  ...
  public class TSSystem : System.Web.Services.WebService
  {
    ...
    public TsMenuItem[] GetMainMenuItems()
    {
      ...
      if (org.ParentID != null)
      {
        ...
        {
          items.Add(new TsMenuItem("dashboard", "mniDashboard", "Dashboard", "vcr/1_8_0/images/nav/20/Dashboard.png", string.Format(data, "vcr/1_8_0/Pages/Dashboard.html", "vcr/1_8_0/PaneInfo/Dashboard.html")));
        }
        ...
        {
          items.Add(new TsMenuItem("reports", "mniReports", "Reports", "vcr/1_8_0/images/nav/20/reports.png", string.Format(data, "vcr/1_8_0/pages/reports.html", "vcr/1_8_0/PaneInfo/Reports.html")));
        }
