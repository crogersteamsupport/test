    ...
    public TsMenuItem[] GetMainMenuItems()
    {
      ...
      if (org.ParentID != null)
      {
        ...
        if (TSAuthentication.OrganizationID == 1078)
        {
            ...
            if (!reports.IsEmpty)
            {
                TsMenuItem ticketViews = new TsMenuItem("tickets", "mniTicketViews", "Ticket Views", "vcr/1_9_0/images/nav/20/reports.png", string.Format(data, "vcr/1_9_0/Pages/Reports_View_Tickets.html?ReportID=" + reports[0].ReportID.ToString(), "vcr/1_9_0/PaneInfo/Reports.html"));
                items.Add(ticketViews);

                foreach (Report report in reports)
                {
                    ticketViews.AddItem(new TsMenuItem("tickettype", "mniTicketView_" + report.ReportID.ToString(), report.Name, "vcr/1_9_0/images/nav/20/reports.png", string.Format(data, "vcr/1_9_0/Pages/Reports_View_Tickets.html?ReportID=" + report.ReportID.ToString(), "vcr/1_9_0/PaneInfo/Reports.html")));
                }
            }
        }
