...
namespace TeamSupport.Data
{
  ...
  public partial class User : BaseItem
  {
    ...
    {
      get { return (int)Row["DaysBeforeExpire"]; }
      set { Row["DaysBeforeExpire"] = CheckValue("DaysBeforeExpire", value); }
    }
  ...
  public partial class Users : BaseCollection, IEnumerable<User>
  {
    ...
    public override void Save(SqlConnection connection)    {
		...
		tempParameter = updateCommand.Parameters.Add("DaysBeforeExpire", SqlDbType.Int, 4);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 10;
		  tempParameter.Scale = 10;
