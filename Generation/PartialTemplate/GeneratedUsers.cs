...
namespace TeamSupport.Data
{
  ...
  public partial class User : BaseItem
  {
    ...
    {
      get { return Row["Information"] != DBNull.Value ? (string)Row["Information"] : null; }
      set { Row["Information"] = CheckNull(value); }
    }
  ...
  public partial class Users : BaseCollection, IEnumerable<User>
  {
    ...
    public override void Save(SqlConnection connection)    {
		...
		tempParameter = updateCommand.Parameters.Add("Information", SqlDbType.VarChar, 500);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 255;
		  tempParameter.Scale = 255;
