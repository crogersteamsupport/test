...
namespace TeamSupport.Data
{
  ...
  public partial class OrganizationsViewItem : BaseItem
  {
    ...
    public string SlaName
    {
      ...
      set { Row["SlaName"] = CheckNull(value); }
    }
  ...
  public partial class OrganizationsView : BaseCollection, IEnumerable<OrganizationsViewItem>
  {
    ...
    public virtual void DeleteFromDB(int organizationID)
    {
      ...
      using (SqlConnection connection = new SqlConnection(LoginUser.ConnectionString))
      {
        ...
        deleteCommand.CommandText = "uspGeneratedDeleteOrganizationsViewItem";
    ...
    public override void Save(SqlConnection connection)    {
		...
		updateCommand.CommandText = "uspGeneratedUpdateOrganizationsViewItem";
		...
		insertCommand.CommandText = "uspGeneratedInsertOrganizationsViewItem";
    ...
    public virtual void LoadByOrganizationID(int organizationID)
    {
      ...
      {
        command.CommandText = "uspGeneratedSelectOrganizationsViewItem";
