...
namespace TeamSupport.Data
{
  ...
  public partial class TicketType : BaseItem
  {
    ...
    public string IconUrl
    {
      ...
      set { Row["IconUrl"] = CheckNull(value); }
    }
  ...
  public partial class TicketTypes : BaseCollection, IEnumerable<TicketType>
  {
    ...
    public virtual void DeleteFromDB(int ticketTypeID)
    {
      ...
      using (SqlConnection connection = new SqlConnection(LoginUser.ConnectionString))
      {
        ...
        deleteCommand.CommandText = "uspGeneratedDeleteTicketType";
    ...
    public override void Save(SqlConnection connection)    {
		...
		updateCommand.CommandText = "uspGeneratedUpdateTicketType";
		...
		insertCommand.CommandText = "uspGeneratedInsertTicketType";
    ...
    public virtual void LoadByTicketTypeID(int ticketTypeID)
    {
      ...
      {
        command.CommandText = "uspGeneratedSelectTicketType";
