...
namespace TeamSupport.Data
{
  ...
  public class ReportEmailProxy
  {
    ...
    [DataMember] public DateTime? DateFailed { get; set; }
  ...
  public partial class ReportEmail : BaseItem
  {
    public ReportEmailProxy GetProxy()
    {
      ...
      result.DateFailed = this.DateFailedUtc == null ? this.DateFailedUtc : DateTime.SpecifyKind((DateTime)this.DateFailedUtc, DateTimeKind.Utc); 
