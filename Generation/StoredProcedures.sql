...
(
  ...
  @ImportFileID int,
  @PortalLimitOrgChildrenTickets bit,
  @CanBulkMerge bit,
  @Identity int OUT
)
AS
...
AS
  ...
  SET
    ...
    [PortalLimitOrgChildrenTickets] = @PortalLimitOrgChildrenTickets,
    [CanBulkMerge] = @CanBulkMerge
  WHERE ([UserID] = @UserID)
GO
