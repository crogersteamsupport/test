...
/9k=";
        ...
        [Test]
        public void JiraClient_ShouldCreateAnAttachmentForExistingIssueWith30MBStream_WithValidParams()
        {
            ...
            if (projectKeys.Any())
            {
                ...
                pathSource = @"C:\Images\Untitled.png";
                // Specify a file to read from and to create.
                // string pathSource = @"c:\tests\source.txt";
                // string pathNew = @"c:\Images\Sample.jpg";
