  ...
  public partial class OrganizationEmails : BaseCollection, IEnumerable<OrganizationEmail>
  {
    ...
    public virtual void DeleteFromDB(int organizationEmailID)
    {
      ...
      using (SqlConnection connection = new SqlConnection(LoginUser.ConnectionString))
      {
        ...
        deleteCommand.CommandText = "uspGeneratedDeleteOrganizationEmail";
    ...
    public override void Save(SqlConnection connection)    {
		...
		updateCommand.CommandText = "uspGeneratedUpdateOrganizationEmail";
		...
		tempParameter = updateCommand.Parameters.Add("Subject", SqlDbType.VarChar, 200);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		...
		insertCommand.CommandText = "uspGeneratedInsertOrganizationEmail";
		...
		tempParameter = insertCommand.Parameters.Add("Subject", SqlDbType.VarChar, 200);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 255;
		  tempParameter.Scale = 255;
    ...
    public virtual void LoadByOrganizationEmailID(int organizationEmailID)
    {
      ...
      {
        command.CommandText = "uspGeneratedSelectOrganizationEmail";
