...
namespace TeamSupport.Data
{
  ...
  public partial class TicketLinkToJira : BaseCollection, IEnumerable<TicketLinkToJiraItem>
  {
    ...
    public override void Save(SqlConnection connection)    {
		...
		insertCommand.CommandText = "SET NOCOUNT OFF; INSERT INTO [dbo].[TicketLinkToJira] (    [TicketID],    [DateModifiedByJiraSync],    [SyncWithJira],    [JiraID],    [JiraKey],    [JiraLinkURL],    [JiraStatus]) VALUES ( @TicketID, @DateModifiedByJiraSync, @SyncWithJira, @JiraID, @JiraKey, @JiraLinkURL, @JiraStatus); SET @Identity = SCOPE_IDENTITY();";
    ...
    public virtual void LoadByid(int id)
    {
      ...
      {
        command.CommandText = "SET NOCOUNT OFF; SELECT [id], [TicketID], [DateModifiedByJiraSync], [SyncWithJira], [JiraID], [JiraKey], [JiraLinkURL], [JiraStatus] FROM [dbo].[TicketLinkToJira] WHERE ([id] = @id);";
