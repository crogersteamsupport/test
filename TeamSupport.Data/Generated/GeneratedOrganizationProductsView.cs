...
namespace TeamSupport.Data
{
  ...
  public partial class OrganizationProductsView : BaseCollection, IEnumerable<OrganizationProductsViewItem>
  {
    ...
    public override void Save(SqlConnection connection)    {
		...
		updateCommand.CommandText = "SET NOCOUNT OFF; UPDATE [dbo].[OrganizationProductsView] SET     [Product] = @Product,    [VersionStatus] = @VersionStatus,    [IsShipping] = @IsShipping,    [IsDiscontinued] = @IsDiscontinued,    [VersionNumber] = @VersionNumber,    [ProductVersionStatusID] = @ProductVersionStatusID,    [ReleaseDate] = @ReleaseDate,    [IsReleased] = @IsReleased,    [Description] = @Description,    [OrganizationID] = @OrganizationID,    [ProductID] = @ProductID,    [ProductVersionID] = @ProductVersionID,    [IsVisibleOnPortal] = @IsVisibleOnPortal,    [SupportExpiration] = @SupportExpiration,    [DateModified] = @DateModified,    [ModifierID] = @ModifierID  WHERE ([OrganizationProductID] = @OrganizationProductID);";
		...
		insertCommand.CommandText = "SET NOCOUNT OFF; INSERT INTO [dbo].[OrganizationProductsView] (    [Product],    [VersionStatus],    [IsShipping],    [IsDiscontinued],    [VersionNumber],    [ProductVersionStatusID],    [ReleaseDate],    [IsReleased],    [Description],    [OrganizationProductID],    [OrganizationID],    [ProductID],    [ProductVersionID],    [IsVisibleOnPortal],    [SupportExpiration],    [DateCreated],    [DateModified],    [CreatorID],    [ModifierID]) VALUES ( @Product, @VersionStatus, @IsShipping, @IsDiscontinued, @VersionNumber, @ProductVersionStatusID, @ReleaseDate, @IsReleased, @Description, @OrganizationProductID, @OrganizationID, @ProductID, @ProductVersionID, @IsVisibleOnPortal, @SupportExpiration, @DateCreated, @DateModified, @CreatorID, @ModifierID); SET @Identity = SCOPE_IDENTITY();";
    ...
    public virtual void LoadByOrganizationProductID(int organizationProductID)
    {
      ...
      {
        command.CommandText = "SET NOCOUNT OFF; SELECT [Product], [VersionStatus], [IsShipping], [IsDiscontinued], [VersionNumber], [ProductVersionStatusID], [ReleaseDate], [IsReleased], [Description], [OrganizationProductID], [OrganizationID], [ProductID], [ProductVersionID], [IsVisibleOnPortal], [SupportExpiration], [DateCreated], [DateModified], [CreatorID], [ModifierID] FROM [dbo].[OrganizationProductsView] WHERE ([OrganizationProductID] = @OrganizationProductID);";
