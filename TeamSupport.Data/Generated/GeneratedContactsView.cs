  ...
  public partial class ContactsView : BaseCollection, IEnumerable<ContactsViewItem>
  {
    ...
    public virtual void DeleteFromDB(int userID)
    {
      ...
      using (SqlConnection connection = new SqlConnection(LoginUser.ConnectionString))
      {
        ...
        deleteCommand.CommandText = "uspGeneratedDeleteContactsViewItem";
    ...
    public override void Save(SqlConnection connection)    {
		...
		updateCommand.CommandText = "uspGeneratedUpdateContactsViewItem";
		...
		insertCommand.CommandText = "uspGeneratedInsertContactsViewItem";
    ...
    public virtual void LoadByUserID(int userID)
    {
      ...
      {
        command.CommandText = "uspGeneratedSelectContactsViewItem";
