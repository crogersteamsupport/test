...
namespace TeamSupport.Data
{
  ...
  public partial class Report : BaseItem
  {
    ...
    {
      get { return (bool)Row["IsDisabled"]; }
      set { Row["IsDisabled"] = CheckValue("IsDisabled", value); }
    }
    
    public int LastTimeTaken
    {
      get { return (int)Row["LastTimeTaken"]; }
      set { Row["LastTimeTaken"] = CheckValue("LastTimeTaken", value); }
    }
  ...
  public partial class Reports : BaseCollection, IEnumerable<Report>
  {
    ...
    public override void Save(SqlConnection connection)    {
		...
		updateCommand.CommandText = "SET NOCOUNT OFF; UPDATE [dbo].[Reports] SET     [OrganizationID] = @OrganizationID,    [Name] = @Name,    [Description] = @Description,    [Query] = @Query,    [CustomFieldKeyName] = @CustomFieldKeyName,    [CustomRefType] = @CustomRefType,    [CustomAuxID] = @CustomAuxID,    [ReportSubcategoryID] = @ReportSubcategoryID,    [QueryObject] = @QueryObject,    [ExternalURL] = @ExternalURL,    [LastSqlExecuted] = @LastSqlExecuted,    [DateModified] = @DateModified,    [ModifierID] = @ModifierID,    [ReportType] = @ReportType,    [ReportDef] = @ReportDef,    [ReportDefType] = @ReportDefType,    [DateEdited] = @DateEdited,    [EditorID] = @EditorID,    [FolderID] = @FolderID,    [IsPrivate] = @IsPrivate,    [LastTimeTaken] = @LastTimeTaken,    [IsDisabled] = @IsDisabled  WHERE ([ReportID] = @ReportID);";
		...
		tempParameter = updateCommand.Parameters.Add("LastTimeTaken", SqlDbType.Int, 4);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 10;
		  tempParameter.Scale = 10;
		...
		tempParameter = updateCommand.Parameters.Add("IsDisabled", SqlDbType.Bit, 1);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 255;
		  tempParameter.Scale = 255;
		...
		insertCommand.CommandText = "SET NOCOUNT OFF; INSERT INTO [dbo].[Reports] (    [OrganizationID],    [Name],    [Description],    [Query],    [CustomFieldKeyName],    [CustomRefType],    [CustomAuxID],    [ReportSubcategoryID],    [QueryObject],    [ExternalURL],    [LastSqlExecuted],    [DateCreated],    [DateModified],    [CreatorID],    [ModifierID],    [ReportType],    [ReportDef],    [ReportDefType],    [DateEdited],    [EditorID],    [FolderID],    [IsPrivate],    [LastTimeTaken],    [IsDisabled]) VALUES ( @OrganizationID, @Name, @Description, @Query, @CustomFieldKeyName, @CustomRefType, @CustomAuxID, @ReportSubcategoryID, @QueryObject, @ExternalURL, @LastSqlExecuted, @DateCreated, @DateModified, @CreatorID, @ModifierID, @ReportType, @ReportDef, @ReportDefType, @DateEdited, @EditorID, @FolderID, @IsPrivate, @LastTimeTaken, @IsDisabled); SET @Identity = SCOPE_IDENTITY();";

		
		tempParameter = insertCommand.Parameters.Add("IsDisabled", SqlDbType.Bit, 1);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 255;
		  tempParameter.Scale = 255;
		...
		tempParameter = insertCommand.Parameters.Add("LastTimeTaken", SqlDbType.Int, 4);
		if (tempParameter.SqlDbType == SqlDbType.Float)
		{
		  tempParameter.Precision = 10;
		  tempParameter.Scale = 10;
    ...
    public virtual void LoadByReportID(int reportID)
    {
      ...
      {
        command.CommandText = "SET NOCOUNT OFF; SELECT [ReportID], [OrganizationID], [Name], [Description], [Query], [CustomFieldKeyName], [CustomRefType], [CustomAuxID], [ReportSubcategoryID], [QueryObject], [ExternalURL], [LastSqlExecuted], [DateCreated], [DateModified], [CreatorID], [ModifierID], [ReportType], [ReportDef], [ReportDefType], [DateEdited], [EditorID], [FolderID], [IsPrivate], [LastTimeTaken], [IsDisabled] FROM [dbo].[Reports] WHERE ([ReportID] = @ReportID);";
