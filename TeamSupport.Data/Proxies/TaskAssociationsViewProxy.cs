...
namespace TeamSupport.Data
{
    public partial class TaskAssociationsViewItem : BaseItem
    {
        ...
        {
            TaskAssociationsViewItemProxy result = TaskAssociationsViewItemProxy.ClassFactory((TaskAssociationsViewItemProxy.References)this.RefType);
            ...
            if (this.RefType == (int)ReferenceType.CompanyActivity || this.RefType == (int)ReferenceType.ContactActivity)
            {
