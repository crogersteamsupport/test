...
namespace TeamSupport.Data
{
    public partial class Report
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            GetTabluarSelectClauseForExport(loginUser, command, builder, tabularReport, inlcudeHiddenFields, isSchemaOnly, sortField, sortDir);
            if (isSchemaOnly)
            {
                command.CommandText = builder.ToString();
            }
        ...
        private static void GetTabluarSelectClauseForExport(LoginUser loginUser, SqlCommand command, StringBuilder builder, TabularReport tabularReport, bool includeHiddenFields, bool isSchemaOnly, string sortField = null, string sortDir = null)
        {
            ReportSubcategory sub = ReportSubcategories.GetReportSubcategory(loginUser, tabularReport.Subcategory);
