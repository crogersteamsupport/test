...
Namespace TeamSupport
    Namespace CrmIntegration
        ...
        End If
            ...
            Private Sub GetContactInformation(ByVal ParentOrgID As String, ByVal LastUpdate As String, ByVal TypeString As String, ByVal AccountIDToUpdate As String, ByVal ForceUpdate As Boolean)
                ...
                Try
                    ...
                    If qr.size > 0 Then
                        ...
                        'check for existence of custom fields to sync
                        GetCustomFields("Contact", TypeString, LastUpdate, AccountIDToUpdate)
            ...
            Private Sub GetCustomFields(ByVal objType As String, ByVal TypeString As String, ByVal LastUpdate As String, Optional ByVal AccountIDToUpdate As String = "")
                Try
            ...
            Private Function TruncateCaseCommentBody(ByVal input As String) As String
              ...
              If input IsNot Nothing AndAlso input.Length > 3700 Then
                Log.Write("Truncated to 3550 too large case comment.")
                Return input.Substring(0, 3550) + "... (This comment has been truncated because it exceeds SalesForce max length of 4000 characters. The full comment is available in TeamSupport.)"
              Else
                Return input
              End If
            End Function
